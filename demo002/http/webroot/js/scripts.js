	...
	*/
	...
	$('.typed-title').typed({
		...
		preStringTyped: function() {
			// $("p").css("color","red");''
			setTimeout(function(){
				var s01=$('#s01').children().html();
				if(s01=="泰弘康医疗供应链金融平台"){
					$(".slide").css("background-image","url(images/pic001.png)");
				}else if(s01=="食药网商城"){
					$(".slide").css("background-image","url(images/pic002.png)");
				}else if(s01=="追溯平台"){
					$(".slide").css("background-image","url(images/bg003.jpg)");
				}else if(s01=="医疗科技投资平台"){
					$(".slide").css("background-image","url(images/pic004.png)");
				}
			},1000);
		}
	});
